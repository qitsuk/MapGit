...
var superMarketRouteShowing = false;
var hotelRouteShowing = false;
var gasStationRouteShowing = false;
...
function createSuperMarketMarker(place) {
    ...
    google.maps.event.addListener(marker, 'click', function () {
        ...
        /*  Then after this line is executed, we add content to the infowindow.
            For these, we are displaying the name, the address, and the image. We also add a button
            for getting directions, from the the event site to the supermarket in question */
        var lat = place.geometry.location.lat();
        var lng = place.geometry.location.lng();
        calculateRouteToSuperMarket(lat, lng);
...
function calculateRouteToSuperMarket(lat, lng) {
